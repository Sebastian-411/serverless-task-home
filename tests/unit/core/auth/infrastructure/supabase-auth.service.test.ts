...
describe("SupabaseAuthService", () => {
  ...
  describe("createUser", () => {
    ...
    it("should throw error when client is not initialized", async () => {
      ...
      const result = await authServiceWithoutInit.createUser(
        "test@example.com",
        "password123",
      );
      expect(result).toBeNull();
  ...
  describe("authenticateUser", () => {
    ...
    it("should handle exceptions gracefully", async () => {
      // Arrange
      (mockAuth.signInWithPassword as any).mockRejectedValue(
  ...
  describe("resetPassword", () => {
    ...
    it("should handle exceptions gracefully", async () => {
      // Arrange
      (mockAuth.resetPasswordForEmail as any).mockRejectedValue(
        new Error("Network error"),
      );
  ...
  describe("updatePassword", () => {
    ...
    it("should handle exceptions gracefully", async () => {
      // Arrange
      (mockAuth.admin.updateUserById as any).mockRejectedValue(
        new Error("Network error"),
      );
  ...
  describe("deleteUser", () => {
    ...
    it("should handle exceptions gracefully", async () => {
      // Arrange
      (mockAuth.admin.deleteUser as any).mockRejectedValue(
        new Error("Network error"),
      );
